...
export function BeerIcon({ size = 16, x, y, style, consumption = false }: {
  ...
  return (
    <svg width={size} height={size} x={x} y={y} viewBox="0 0 16 16"
      ...
      <path d="M4 1.5h8q4 6.5 0 13H4q-4-6.5 0-13Z" fill="#c4b38f" stroke="#34423e" strokeWidth={1} />
      <path d="M2.5 5h11M2.5 11h11M8 2v12" fill="none" stroke="#34423e" strokeWidth={1} />
